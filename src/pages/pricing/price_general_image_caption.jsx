...
const productData = [
  ...
  { id: 3, name: 'funny animals of the week , animal pictures', image: gic3,clipScore:   0.2683, quantity: 1/8, diversity: 1/8 , cost:20},
  { id: 4, name: 'celebrities start decorating for the christmas season lifestyle', image: gic4,clipScore:0.314, quantity: 1/8, diversity: 1/8   , cost:23},
  { id: 5, name: 'heavy snow falls over a snow lined river .', image: gic5,clipScore:0.2338, quantity: 1/8, diversity: 1/8-0.02  , cost:16 },
  { id: 6, name: 'american football player looks downfield during the second half of a football game against sports team', image: gic6,clipScore:0.4219, quantity: 1/8, diversity: 1/8, cost:27},
  { id: 7, name: 'functions of government : 1 . form a more perfect union', image: gic7,clipScore:0.292, quantity: 1/8, diversity: 1/8+0.04, cost:18 },
  { id: 8, name: 'dunes lay the blueprint for the back nine .', image: gic8,clipScore:0.3027, quantity: 1/8, diversity: 1/8, cost:20},
  // 
];
